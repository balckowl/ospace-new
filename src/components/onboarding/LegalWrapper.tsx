        ...
        <div className="mx-auto max-w-4xl px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <h1
                className={`font-bold text-gray-800 text-xl ${litteOne.className}`}
              >
                OSPACE
              </h1>
            </div>
              ...
              <TabsContent value="terms" className="mt-0">
                <div className="prose prose-gray max-w-none space-y-6">
                  ...
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      By accessing and using OSpace, you accept and agree to be
                  ...
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Permission is granted to temporarily use OSpace for
                  ...
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      store using OSpace. However, by using our service, you
                      grant us a license to host, store, and display your
                  ...
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      The materials on OSpace are provided on an &#39;as is&#39;
                      basis. OSpace makes no warranties, expressed or implied,
                  ...
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      please contact us at ospace220@gmail.com
                    </p>
                  </section>
                </div>
              </TabsContent>
              ...
              <TabsContent value="privacy" className="mt-0">
                <div className="prose prose-gray max-w-none space-y-6">
                  ...
                  <section>
                    ...
                    <ul className="ml-4 list-inside list-disc space-y-2 text-gray-600 leading-relaxed">
                      <li>
                        Account information (email address, profile information)
                      </li>

...
export default function Header({ children }: Props) {
  return (
    <div className="fixed z-30 w-full bg-linear-to-br">
      <div className="mx-auto max-w-[1300px] px-3">
        <div className="flex h-[70px] items-center justify-between">
          <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/8 px-3 py-1 backdrop-blur-md">
